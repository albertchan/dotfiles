...
description: A specification for adding human and machine readable meaning to commit messages. Use PROACTIVELY when generating commit messages for code changes, ensuring they follow the Conventional Commits format for clarity and consistency.
---

# Conventional Commits Messages

The Conventional Commits specification provides a standardized format for commit messages to improve readability and automation.
